    ...
    public function behaviors(): array
    {
        return [
            [
                ...
                'attribute' => 'file',
                'createThumbsOnRequest' => true,  // if we delete static/cache it regenerate from static/origin
                ...
                'thumbs' => [
                    ...
                    'catalog_product_main' => ['processor' => [new WaterMarker(750, 1000, '@frontend/web/images/logo.png'), 'process']],
                    'catalog_product_additional' => ['width' => 66, 'height' => 66],
                    'catalog_origin' => ['processor' => [new WaterMarker(1024, 768, '@frontend/web/images/logo.png'), 'process']],
                ],
            ],
        ];
    }
